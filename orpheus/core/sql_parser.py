...
class SQLParser(object):
	...
	def get_from_clause(self, dataset_name, touched_table):
		# rule based !
		datatable = dataset_name + const.DATA_SUFFIX
		indextable = dataset_name + const.INDEX_SUFFIX
		versiontable = dataset_name + const.VERSION_SUFFIX
        attributetable = dataset_name + const.ATTRIBUTE_SUFFIX # TODO: add
